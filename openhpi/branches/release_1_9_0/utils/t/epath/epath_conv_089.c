...
int main(int argc, char **argv) 
{
        ...
        char *entity_root = "{COMPACTPCI_CHASSIS,84}{POWER_MODULE,48}";
	    ...
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[0].EntityType, SAHPI_ENT_POWER_MODULE);
	    return -1;
	}
        ...
        if (tmp_ep.Entry[1].EntityLocation != 84) {
	    printf("ERROR! Testcase failed Entry[1].EntityLocation compare\n");
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[1].EntityLocation, 84);
	    return -1;
	}
