...
/**
 * main: Invokes rpt_diff with new table param as NULL.
...
int main(int argc, char **argv)
{
	...
	GSList *new_res = NULL, *new_rdr = NULL, *gone_res = NULL, *gone_rdr = NULL;
	...
	rpt_diff(curr_table, NULL, &new_res, &new_rdr, &gone_res, &gone_rdr);
