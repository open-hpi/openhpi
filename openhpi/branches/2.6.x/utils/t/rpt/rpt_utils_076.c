...
/**
 * main: Invokes rpt_diff with gone_res param as NULL.
...
int main(int argc, char **argv)
{
	...
	GSList *new_res = NULL, *new_rdr = NULL, *gone_rdr = NULL;
	...
	rpt_diff(curr_table, new_table, &new_res, &new_rdr, NULL, &gone_rdr);
