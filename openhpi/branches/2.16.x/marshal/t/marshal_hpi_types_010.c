...
{
  tUint8 m_pad1;
  SaHpiCtrlStateTextT m_v1;
  tUint8 m_pad2;
  SaHpiCtrlStateTextT m_v2;
  SaHpiCtrlStateTextT m_v3;
  tUint8 m_pad3;
} cTest;
...
cMarshalType StructElements[] =
{
  ...
  dStructElement( cTest, m_v1   , SaHpiCtrlStateTextType ),
  dStructElement( cTest, m_pad2 , Marshal_Uint8Type ),
  dStructElement( cTest, m_v2   , SaHpiCtrlStateTextType ),
  dStructElement( cTest, m_v3   , SaHpiCtrlStateTextType ),
...
main( int argc, char *argv[] )
{
  cTest value =
  {
    .m_pad1 = 47,
    .m_v1.Line            = 1,
    .m_v1.Text.DataType   = SAHPI_TL_TYPE_BINARY,
    .m_v1.Text.Language   = SAHPI_LANG_TSONGA,
    .m_v1.Text.DataLength = 3,
    .m_v1.Text.Data       = "AB",
    .m_pad2               = 48,
    .m_v2.Line            = 1,
    .m_v2.Text.DataType   = SAHPI_TL_TYPE_BCDPLUS,
    .m_v2.Text.Language   = SAHPI_LANG_SANGRO,
    .m_v2.Text.DataLength = 21,
    .m_v2.Text.Data       = "12345678901234567890",
    .m_v3.Line            = 1,
    .m_v3.Text.DataType   = SAHPI_TL_TYPE_ASCII6,
    .m_v3.Text.Language   = SAHPI_LANG_TAJIK,
    .m_v3.Text.DataLength = 0,
    .m_v3.Text.Data       = "",
    .m_pad3 = 49
  };
  ...
  if ( !cmp_ctrlstatetext( &value.m_v1, &result.m_v1 ) )
       return 1;

  if ( value.m_pad2 != result.m_pad2 )
       return 1;

  if ( !cmp_ctrlstatetext( &value.m_v2, &result.m_v2 ) )
       return 1;

  if ( !cmp_ctrlstatetext( &value.m_v3, &result.m_v3 ) )
       return 1;
