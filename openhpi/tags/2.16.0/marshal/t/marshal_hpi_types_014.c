...
static int
cmp_ctrlrecdiscrete( SaHpiCtrlRecDiscreteT *d1, SaHpiCtrlRecDiscreteT *d2 )
{
...
{
  tUint8 m_pad1;
  SaHpiCtrlRecDiscreteT m_v1;
  tUint8 m_pad2;
  SaHpiCtrlRecDiscreteT m_v2;
  SaHpiCtrlRecDiscreteT m_v3;
  tUint8 m_pad3;
} cTest;
...
cMarshalType StructElements[] =
{
  ...
  dStructElement( cTest, m_v1   , SaHpiCtrlRecDiscreteType ),
  dStructElement( cTest, m_pad2 , Marshal_Uint8Type ),
  dStructElement( cTest, m_v2   , SaHpiCtrlRecDiscreteType ),
  dStructElement( cTest, m_v3   , SaHpiCtrlRecDiscreteType ),
...
main( int argc, char *argv[] )
{
  ...
  if ( !cmp_ctrlrecdiscrete( &value.m_v1, &result.m_v1 ) )
       return 1;

  if ( value.m_pad2 != result.m_pad2 )
       return 1;

  if ( !cmp_ctrlrecdiscrete( &value.m_v2, &result.m_v2 ) )
       return 1;

  if ( !cmp_ctrlrecdiscrete( &value.m_v3, &result.m_v3 ) )
       return 1;
