...
int main(int argc, char **argv) 
{
        ...
        char *entity_root = "{DRIVE_BACKPLANE,98}{SYSTEM_BUS,91}";
        ...
        if(tmp_ep.Entry[0].EntityInstance != 91)
                return 1;
        
        if(tmp_ep.Entry[1].EntityType != SAHPI_ENT_DRIVE_BACKPLANE)
                return 1;
        
        if(tmp_ep.Entry[1].EntityInstance != 98)
                return 1;
