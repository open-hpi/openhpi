...
**
**   Copyright 2004, 2007 by the Service Availability Forum.
**   All rights reserved.
**
...
*/
#define SAHPI_INTERFACE_VERSION (SaHpiVersionT)0x020201 /* B.02.01 */
...
typedef struct {
    /*SaHpiDimiTotalTestsT*/ SaHpiUint32T    NumberOfTests;  /* It is recommended that the DIMI
...
typedef SaHpiInstrumentIdT SaHpiBankNumT;
...
**   expected follow the procedure described in Section  - Discovery to gather
**   information about the Domain after a Session has been opened.
**
*******************************************************************************/
...
**   instruments are identified in Section .
...
**      value (SensorThreshold -> NegThdHysteresis).
**   SA_ERR_HPI_INVALID_PARAMS is returned if the SensorThresholds pointer is
**      passed in as NULL.
**
** Remarks:
...
**         set, and the DeassertEventMask parameter is not
...
**
** Remarks:
**   See the description of the SaHpiWatchdogT structure in Section  for details
**   on what information is returned by this function.
...
**      and Severity is not one of the valid enumerated values for this type.
**   SA_ERR_HPI_NOT_PRESENT is returned if:
**   The AnnunciatorNum passed does not address a valid Annunciator supported by
**      the resource
...
**         delete announcements in the set; an HPI User may add or delete
**         announcements in the set.
**   SAHPI_ANNUNCIATOR_MODE_SHARED - both the HPI implementation and an HPI User
**      may add or delete announcements in the set.
**
** Return Value:
**   SA_OK is returned on successful completion; otherwise, an error code is
**      returned.
...
**
*******************************************************************************/
SaErrorT SAHPI_API saHpiSourceInfoValidateStart (
    SAHPI_IN    SaHpiSessionIdT       SessionId,
    SAHPI_IN    SaHpiResourceIdT      ResourceId,
    SAHPI_IN    SaHpiFumiNumT	      FumiNum,
    SAHPI_IN    SaHpiBankNumT	      BankNum
...
**   SAHPI_DEFAULT_PARM	Restores the factory default settings for a specific
**      resource. Factory defaults include Sensor thresholds and configurations,
...
**      non-volatile stor"age. Resource configuration parameters include Sensor
...
**      of LoadId->LoadNumber and LoadId->LoadName.  If LoadId->LoadNumber is:
**   SAHPI_LOAD_ID_DEFAULT: The entity will load implementation-defined default
**      software,
**   SAHPI_LOAD_ID_BYNAME:  The entity will load software identified by the
**      contents of
**   LoadId->LoadName,
**   Any other value:  The entity will load software identified by the value of
**      LoadId->LoadNumber.
**
** Return Value:
**   SA_OK is returned on successful completion; otherwise, an error code is
