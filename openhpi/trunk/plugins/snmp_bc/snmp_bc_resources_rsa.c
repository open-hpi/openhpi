...
struct snmp_bc_sensor snmp_bc_chassis_sensors_rsa[] = {
		...
		.sensor_info = {
			.mib = {
				...
				.write_only = 0,
                                .oid = ".1.3.6.1.4.1.2.3.51.1.2.20.1.1.1.1.2.1",
				.threshold_oids = {
		...
		.sensor_info = {
			.mib = {
				.not_avail_indicator_num = 0,
				.write_only = 0,
                                .oid = ".1.3.6.1.4.1.2.3.51.1.2.20.1.1.1.1.2.3",
				.threshold_oids = {
		...
		.sensor_info = {
			.mib = {
				.not_avail_indicator_num = 0,
				.write_only = 0,
                                .oid = ".1.3.6.1.4.1.2.3.51.1.2.20.1.1.1.1.2.4",
				.threshold_oids = {
		...
		.sensor_info = {
			.mib = {
				.not_avail_indicator_num = 0,
				.write_only = 0,
                                .oid = ".1.3.6.1.4.1.2.3.51.1.2.20.1.1.1.1.2.5",
				.threshold_oids = {
		...
		.sensor_info = {
			.mib = {
				.not_avail_indicator_num = 0,
				.write_only = 0,
                                .oid = ".1.3.6.1.4.1.2.3.51.1.2.20.1.1.1.1.2.6",
				.threshold_oids = {
