...
/**
 * set_epath_instance test7.
 *   call set_epath_instance with entity path that has 4 elements, victim element in middle
...
int main(int argc, char **argv)
{
        ...
        if(set_epath_instance(&ep, SAHPI_ENT_SYSTEM_SLOT, x)) {
