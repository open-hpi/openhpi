...
int main(int argc, char **argv) 
{
        ...
        char *entity_root = "{BIOS,86}{DISK_DRIVE_BAY,80}";
	    ...
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[0].EntityType, SAHPI_ENT_DISK_DRIVE_BAY);
	    return -1;
	}
        ...
        if (tmp_ep.Entry[1].EntityLocation != 86) {
	    printf("ERROR! Testcase failed Entry[1].EntityLocation compare\n");
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[1].EntityLocation, 86);
	    return -1;
	}
