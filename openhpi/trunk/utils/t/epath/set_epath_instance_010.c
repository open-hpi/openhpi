...
/**
 * set_epath_instance test10.
 *   call set_epath_instance with entity type not in multi element entity path
 *   expected result: set_epath_instance returns failure
 *
...
int main(int argc, char **argv)
{
        ...
        if(set_epath_instance(&ep, SAHPI_ENT_FAN, x) == 0) {
