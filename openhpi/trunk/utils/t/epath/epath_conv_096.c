...
int main(int argc, char **argv) 
{
        ...
        char *entity_root = "{ADVANCEDTCA_CHASSIS,29}{POWER_SYSTEM_BOARD,40}";
        ...
        if(tmp_ep.Entry[0].EntityLocation != 40)
                return 1;
        
        if(tmp_ep.Entry[1].EntityType != SAHPI_ENT_ADVANCEDTCA_CHASSIS)
                return 1;
        
        if(tmp_ep.Entry[1].EntityLocation != 29)
                return 1;
