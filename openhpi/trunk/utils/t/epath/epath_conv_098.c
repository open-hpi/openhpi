...
int main(int argc, char **argv) 
{
        ...
        char *entity_root = "{MEMORY_DEVICE,51}{OTHER_CHASSIS_BOARD,91}";
        ...
        if (tmp_ep.Entry[0].EntityLocation != 91) {
	    printf("ERROR! Testcase failed Entry[0].EntityLocation compare\n");
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[0].EntityLocation, 91);
	    return -1;
	}
	    ...
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[1].EntityLocation, 51);
	    return -1;
	}
