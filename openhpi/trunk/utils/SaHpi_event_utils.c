...
#include <SaHpi_event_utils.c.embed>

#define OH_EVENT_DELIMITER " | "
#define OH_EVENT_DELIMITER_CHAR "|"
#define OH_EVENT_DELIMITER_LENGTH 3
			      ...
			      SaHpiTextBufferT *buffer)
{
	...
	if (found) {
		for (i=0; i<OH_EVENT_DELIMITER_LENGTH + 1; i++) {
			      ...
			      SaHpiEventCategoryT *event_cat)
{
	...
	eventdefs = g_strsplit(gstr, OH_EVENT_DELIMITER_CHAR, -1);
	if (eventdefs == NULL) {
