...
static const char *plugin_params_lan_remote[] =
{
  ...
  "AtcaConnectionTimeout", "2000",
  "MaxOutstanding", "3",
  // "MC20",       "initial_discover poll_alive poll_dead",
  // "MCB0",       "initial_discover poll_alive poll_dead",
  // "MCB2",       "initial_discover poll_alive poll_dead",
  // "MCB4",       "initial_discover poll_alive poll_dead",
  0
};
