...
SaErrorT snmp_rsa_get_control_state(void *hnd, SaHpiResourceIdT id,
				   SaHpiCtrlNumT num,
...
SaErrorT snmp_rsa_set_control_state(void *hnd, SaHpiResourceIdT id,
                                     SaHpiCtrlNumT num,
                                     SaHpiCtrlStateT *state)
{
        gchar *oid;
