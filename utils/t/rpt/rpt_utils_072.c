...
/**
 * main: Invokes rpt_diff with current table param as NULL.
...
int main(int argc, char **argv)
{
	...
	GSList *new_res, *new_rdr, *gone_res, *gone_rdr;
	...
	rpt_diff(NULL, new_table, &new_res, &new_rdr, &gone_res, &gone_rdr);
