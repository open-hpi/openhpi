...
int main(int argc, char **argv) 
{
        ...
        /* SAHPI_EC_UNSPECIFIED - SAHPI_ES_UNSPECIFIED testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_UNSPECIFIED - SAHPI_ES_UNSPECIFIED decode failed\n");
        ...
        /* SAHPI_EC_LIMIT - SAHPI_ES_LIMIT_NOT_EXCEEDED testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_LIMIT - SAHPI_ES_LIMIT_NOT_EXCEEDED decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_LIMIT - SAHPI_ES_LIMIT_EXCEEDED testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_LIMIT - SAHPI_ES_LIMIT_EXCEEDED decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_THRESHOLD - SAHPI_ES_LOWER_MINOR testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_THRESHOLD - SAHPI_ES_LOWER_MINOR decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_THRESHOLD - SAHPI_ES_LOWER_MINOR | SAHPI_ES_LOWER_MAJOR testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_THRESHOLD - SAHPI_ES_LOWER_MINOR | SAHPI_ES_LOWER_MAJOR decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_THRESHOLD - SAHPI_ES_LOWER_MINOR | SAHPI_ES_LOWER_MAJOR | SAHPI_ES_LOWER_CRIT testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_THRESHOLD - SAHPI_ES_LOWER_MINOR | SAHPI_ES_LOWER_MAJOR | SAHPI_ES_LOWER_CRIT decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_THRESHOLD - SAHPI_ES_UPPER_MINOR testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_THRESHOLD - SAHPI_ES_UPPER_MINOR decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_THRESHOLD - SAHPI_ES_UPPER_MINOR | SAHPI_ES_UPPER_MAJOR testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_THRESHOLD - SAHPI_ES_UPPER_MINOR | SAHPI_ES_UPPER_MAJOR decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_THRESHOLD - SAHPI_ES_UPPER_MINOR | SAHPI_ES_UPPER_MAJOR | SAHPI_ES_UPPER_CRIT testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_THRESHOLD - SAHPI_ES_UPPER_MINOR | SAHPI_ES_UPPER_MAJOR | SAHPI_ES_UPPER_CRIT decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_PRESENCE - SAHPI_ES_ABSENT testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_PRESENCE - SAHPI_ES_ABSENT decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_PRESENCE - SAHPI_ES_PRESENT testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_PRESENCE - SAHPI_ES_PRESENT decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_SEVERITY - SAHPI_ES_OK testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_SEVERITY - SAHPI_ES_OK decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_SEVERITY - SAHPI_ES_MINOR_FROM_OK testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_SEVERITY - SAHPI_ES_MINOR_FROM_OK decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_SEVERITY - SAHPI_ES_MAJOR_FROM_LESS testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_SEVERITY - SAHPI_ES_MAJOR_FROM_LESS decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_SEVERITY - SAHPI_ES_CRITICAL_FROM_LESS testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_SEVERITY - SAHPI_ES_CRITICAL_FROM_LESS decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_SEVERITY - SAHPI_ES_MINOR_FROM_MORE testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_SEVERITY - SAHPI_ES_MINOR_FROM_MORE decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_SEVERITY - SAHPI_ES_MAJOR_FROM_CRITICAL testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_SEVERITY - SAHPI_ES_MAJOR_FROM_CRITICAL decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_SEVERITY - SAHPI_ES_CRITICAL testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_SEVERITY - SAHPI_ES_CRITICAL decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_SEVERITY - SAHPI_ES_MONITOR testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_SEVERITY - SAHPI_ES_MONITOR decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_SEVERITY - SAHPI_ES_INFORMATIONAL testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_SEVERITY - SAHPI_ES_INFORMATIONAL decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_STATE - SAHPI_ES_STATE_DEASSERTED testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_STATE - SAHPI_ES_STATE_DEASSERTED decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_STATE - SAHPI_ES_STATE_ASSERTED testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_STATE - SAHPI_ES_STATE_ASSERTED decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_REDUNDANCY - SAHPI_ES_FULLY_REDUNDANT testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_REDUNDANCY - SAHPI_ES_FULLY_REDUNDANT decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_LOST testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_LOST decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_DEGRADED testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_DEGRADED decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_LOST_SUFFICIENT_RESOURCES testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_LOST_SUFFICIENT_RESOURCES decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_REDUNDANCY - SAHPI_ES_NON_REDUNDANT_SUFFICIENT_RESOURCES testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_REDUNDANCY - SAHPI_ES_NON_REDUNDANT_SUFFICIENT_RESOURCES decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_REDUNDANCY - SAHPI_ES_NON_REDUNDANT_INSUFFICIENT_RESOURCES testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_REDUNDANCY - SAHPI_ES_NON_REDUNDANT_INSUFFICIENT_RESOURCES decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_DEGRADED_FROM_FULL testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_DEGRADED_FROM_FULL decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_DEGRADED_FROM_NON testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_REDUNDANCY - SAHPI_ES_REDUNDANCY_DEGRADED_FROM_NON decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_00 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_00 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_01 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_01 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_02 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_02 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_03 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_03 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_04 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_04 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_05 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_05 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_06 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_06 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_07 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_07 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_08 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_08 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_09 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_09 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_10 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_10 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_11 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_11 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_12 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_12 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_13 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_13 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
        ...
        /* SAHPI_EC_GENERIC - SAHPI_ES_STATE_14 testcase */
        {
                ...
                if (strcmp(expected_str, buffer.Data)) {
                        printf("  Error! Line __LINE__ Testcase SAHPI_EC_GENERIC - SAHPI_ES_STATE_14 decode failed\n");
                        printf("  Received string=%s\n", buffer.Data);
			printf("  Expected string=%s\n", expected_str);
                        return -1;             
                }
