...
int main(int argc, char **argv) 
{
        ...
        char *entity_root = "{DISK_DRIVE,31}{PROCESSOR_MODULE,53}";
        ...
        if(tmp_ep.Entry[0].EntityInstance != 53)
                return 1;
        
        if(tmp_ep.Entry[1].EntityType != SAHPI_ENT_DISK_DRIVE)
                return 1;
        
        if(tmp_ep.Entry[1].EntityInstance != 31)
                return 1;
