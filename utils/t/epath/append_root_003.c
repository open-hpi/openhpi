...
/**
 * append_root test 3.
 *          append root to entity path 
 *          expected result: root appended after last element
 * Return value: 0 on success, 1 on failure
 **/
int main(int argc, char **argv)
{
        SaHpiEntityPathT ep = {{{SAHPI_ENT_BATTERY,1},{SAHPI_ENT_GROUP,2},{0}}};
        int mydebug = 0;
        ...
        if(ep.Entry[2].EntityInstance != 0) {
