...
int main(int argc, char **argv) 
{
        ...
        char *entity_root = "{SBC_SUBBOARD,95}{BACK_PANEL_BOARD,76}";
        ...
        if (tmp_ep.Entry[0].EntityLocation != 76) {
	    printf("ERROR! Testcase failed Entry[0].EntityLocation compare\n");
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[0].EntityLocation, 76);
	    return -1;
	}
        ...
        if (tmp_ep.Entry[1].EntityLocation != 95) {
	    printf("ERROR! Testcase failed Entry[1].EntityLocation compare\n");
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[1].EntityLocation, 95);
	    return -1;
	}
