...
int main(int argc, char **argv) 
{
        ...
        char *entity_root = "{PROCESSOR_MODULE,31}{ADVANCEDTCA_CHASSIS,66}";
	    ...
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[1].EntityType, SAHPI_ENT_PROCESSOR_MODULE);
	    return -1;
	}
        
        if (tmp_ep.Entry[1].EntityLocation != 31) {
	    printf("ERROR! Testcase failed Entry[1].EntityLocation compare\n");
	    printf("Received=%d; Expected=%d\n", tmp_ep.Entry[1].EntityLocation, 31);
	    return -1;
	}
